...
import {
  createContainer, VictoryLine, VictoryArea, VictoryStack, VictoryChart, VictoryBrushContainer, VictoryAxis,
} from 'victory';
  ...
  return (
    <div>
      ...
      >
        ...
        <VictoryLine
          data={[[props.startDate - 1, props.cdnMax], [props.endDate - 1, props.cdnMax]]}
          x={0}
          y={1}
        ...
        <VictoryLine
          data={[[props.startDate - 1, props.p2pAndCdnMax], [props.endDate - 1, props.p2pAndCdnMax]]}
          x={0}
          y={1}
